...
Shader "FlowShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( ( tex2D( _WaterFoam, ( i.uv_texcoord + ( float2( -0.2,-0.35 ) * _Time.y ) ) ).r + pow( gradientNoise22 , 1.25 ) ) * _WaterColor ).rgb;
			o.Alpha = 1;
...
/*ASEBEGIN
Version=18500
-1920;0;1920;1019;1682.581;828.4761;1.3;True;False
...
Node;AmplifyShaderEditor.ColorNode;20;-422.6251,-367.0313;Inherit;False;Property;_WaterColor;WaterColor;6;1;[HDR];Create;True;0;0;False;0;False;0,1.521569,4,0;0,1.521569,4,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CABF46BC895F03D10294A7BC11095FE94E67EB17